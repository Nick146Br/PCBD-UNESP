...
if (isset($_POST['Registrar'])) {
    ...
    if ($flag == false) {
        ...
        header("Location: unregister_to_contest.php");
    }
}
...
<button class = "button-1" role="button"
    ...
    <div class="container" id="cad_submissao" style="min-width: 400px; height: 800px">
        ...
        <form action="" method="POST" class="login-email" id="form_submission">
            ...
            <p class="login-text" style="font-size: 2rem; font-weight: 800;">Contests que <?php echo $nickname?> já está registrado</p>

            <div class="input-group">
                <button name="Registrar" class="btn">Unregistrar em Contest</button>
            </div>
        ...
        <div class = "login-email">
            <button name="" class="btn" style="margin-top: 10px;" onclick="location.href = 'register_to_contest.php';">Registrar</button>
        </div> 
    </div>
</body>
